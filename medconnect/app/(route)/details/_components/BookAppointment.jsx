...
<Dialog>
  <DialogTrigger>
  <Button className="mt-2 rounded-full">Book Appointment</Button>

  

  </DialogTrigger>
  <DialogContent className="md:max-w-[625px] max-w-80">
    <DialogHeader>
      ...
      <DialogDescription>
            <div>
                ...
                <Textarea className="mt-3" placeholder="Note"  value={note} onChange={handleNoteChange } />
            </div>
      </DialogDescription>
    </DialogHeader>
